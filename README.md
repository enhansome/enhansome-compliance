...
* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 38,064 | 🐛 265 | 🌐 Go | 📅 2026-09-24 - Comprehensive security scanner for containers and IaC. Detects vulnerabilities, misconfigurations, secrets.
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,862 | 🐛 381 | 🌐 Python | 📅 2026-09-24 - AWS security and compliance scanner. Checks against AWS CIS Benchmark, GDPR, HIPAA, PCI DSS, SOC 2.
* [kube-bench](https://github.com/aquasecurity/kube-bench) ⭐ 8,197 | 🐛 108 | 🌐 Go | 📅 2026-09-22 - Checks Kubernetes clusters against CIS Kubernetes Benchmark.
* [ScoutSuite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,828 | 🐛 298 | 🌐 Python | 📅 2025-09-23 - Multi-cloud security auditing tool by NCC Group. Detects misconfigurations in AWS, Azure, GCP.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,593 | 🐛 61 | 🌐 Go | 📅 2026-09-24 - Policy-as-code runtime authorization for human and non-human identities. Audit logs of every access decision (Apache-2.0).
* [CISO Assistant](https://github.com/intuitem/ciso-assistant-community) ⭐ 4,450 | 🐛 113 | 🌐 Python | 📅 2026-09-24 - Open-source GRC app supporting 40+ frameworks. Manages risks, controls, audits with one-click audit reports.
* [Comp AI](https://github.com/trycompai/comp) ⭐ 1,990 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-24 - Open source compliance platform (AGPL-3.0) for SOC 2, ISO 27001, HIPAA, GDPR.
* [Probo](https://github.com/getprobo/probo) ⭐ 1,383 | 🐛 88 | 🌐 Go | 📅 2026-09-24 - Open source compliance automation focused on continuous integration workflows.
...
* [Trestle](https://github.com/IBM/compliance-trestle) ⭐ 278 | 🐛 44 | 🌐 Python | 📅 2026-09-24 - IBM's compliance-as-code toolset using NIST's OSCAL format. Manages compliance catalogs and automates documentation generation.
...
* [open-isms](https://github.com/NISD2/open-isms) ⭐ 15 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-24 - Self-hostable ISMS for the EU NIS 2 Directive (AGPL-3.0). Covers the 49 requirements from Directive 2022/2555 and Implementing Regulation 2024/2690, with GDPR, ISO 27001, the EU AI Act and the CRA mapped against them. Owner, deadline and sign-off per requirement, plus an append-only audit trail. ([Website](https://www.nisd2.eu) | [Self-hosting](https://github.com/NISD2/open-isms/blob/main/docs/self-hosting.md) ⭐ 15 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-24)
