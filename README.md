...
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,713 | 🐛 337 | 🌐 Python | 📅 2026-08-28 - AWS security and compliance scanner. Checks against AWS CIS Benchmark, GDPR, HIPAA, PCI DSS, SOC 2.
...
* [Asqav](https://github.com/jagmarques/asqav-sdk) ⭐ 411 | 🐛 0 | 🌐 Python | 📅 2026-08-27 - Open-source SDK for AI agent governance with tamper-evident audit trails, tool scanning, and enforcement policies (MIT). Designed for teams running AI agents in production who need compliance-ready logging and control.
