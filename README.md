...
* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,736 | 🐛 265 | 🌐 Go | 📅 2026-09-01 - Comprehensive security scanner for containers and IaC. Detects vulnerabilities, misconfigurations, secrets.
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,736 | 🐛 354 | 🌐 Python | 📅 2026-09-01 - AWS security and compliance scanner. Checks against AWS CIS Benchmark, GDPR, HIPAA, PCI DSS, SOC 2.
...
* [ScoutSuite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,809 | 🐛 296 | 🌐 Python | 📅 2025-09-23 - Multi-cloud security auditing tool by NCC Group. Detects misconfigurations in AWS, Azure, GCP.
* [CISO Assistant](https://github.com/intuitem/ciso-assistant-community) ⭐ 4,397 | 🐛 109 | 🌐 Python | 📅 2026-09-01 - Open-source GRC app supporting 40+ frameworks. Manages risks, controls, audits with one-click audit reports.
* [Comp AI](https://github.com/trycompai/comp) ⭐ 1,915 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-09 - Open source compliance platform (AGPL-3.0) for SOC 2, ISO 27001, HIPAA, GDPR.
...
* [Probo](https://github.com/getprobo/probo) ⭐ 1,327 | 🐛 81 | 🌐 Go | 📅 2026-09-01 - Open source compliance automation focused on continuous integration workflows.
...
* [Asqav](https://github.com/jagmarques/asqav-sdk) ⭐ 431 | 🐛 0 | 🌐 Python | 📅 2026-09-01 - Open-source SDK for AI agent governance with tamper-evident audit trails, tool scanning, and enforcement policies (MIT). Designed for teams running AI agents in production who need compliance-ready logging and control.
...
* [Trestle](https://github.com/IBM/compliance-trestle) ⭐ 274 | 🐛 43 | 🌐 Python | 📅 2026-09-01 - IBM's compliance-as-code toolset using NIST's OSCAL format. Manages compliance catalogs and automates documentation generation.
...
* [LLM ISO27001](https://github.com/kriss-b/llm-iso27001) ⭐ 37 | 🐛 8 | 📅 2026-08-30 - Open-source ISO 27001 (+ 42001 + NIS2) ISMS framework designed to be entirely managed by LLM Agents
...
* [Apotrope](https://github.com/hexorcist404/apotrope) ⭐ 12 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - Offline security posture auditor for Windows. Runs 50+ checks mapped to CIS Microsoft Windows Benchmarks and generates scored HTML/JSON reports.
