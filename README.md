...
* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,859 | 🐛 271 | 🌐 Go | 📅 2026-09-10 - Comprehensive security scanner for containers and IaC. Detects vulnerabilities, misconfigurations, secrets.
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,789 | 🐛 370 | 🌐 Python | 📅 2026-09-10 - AWS security and compliance scanner. Checks against AWS CIS Benchmark, GDPR, HIPAA, PCI DSS, SOC 2.
* [kube-bench](https://github.com/aquasecurity/kube-bench) ⭐ 8,178 | 🐛 103 | 🌐 Go | 📅 2026-09-07 - Checks Kubernetes clusters against CIS Kubernetes Benchmark.
...
* [CISO Assistant](https://github.com/intuitem/ciso-assistant-community) ⭐ 4,421 | 🐛 112 | 🌐 Python | 📅 2026-09-10 - Open-source GRC app supporting 40+ frameworks. Manages risks, controls, audits with one-click audit reports.
* [Comp AI](https://github.com/trycompai/comp) ⭐ 1,948 | 🐛 36 | 🌐 TypeScript | 📅 2026-09-09 - Open source compliance platform (AGPL-3.0) for SOC 2, ISO 27001, HIPAA, GDPR.
...
* [Probo](https://github.com/getprobo/probo) ⭐ 1,350 | 🐛 93 | 🌐 Go | 📅 2026-09-10 - Open source compliance automation focused on continuous integration workflows.
...
* [Asqav](https://github.com/jagmarques/asqav-sdk) ⭐ 496 | 🐛 7 | 🌐 Python | 📅 2026-09-09 - Open-source SDK for AI agent governance with tamper-evident audit trails, tool scanning, and enforcement policies (MIT). Designed for teams running AI agents in production who need compliance-ready logging and control.
...
* [Trestle](https://github.com/IBM/compliance-trestle) ⭐ 274 | 🐛 45 | 🌐 Python | 📅 2026-09-10 - IBM's compliance-as-code toolset using NIST's OSCAL format. Manages compliance catalogs and automates documentation generation.
...
* [LLM ISO27001](https://github.com/kriss-b/llm-iso27001) ⭐ 41 | 🐛 8 | 📅 2026-09-10 - Open-source ISO 27001 (+ 42001 + NIS2) ISMS framework designed to be entirely managed by LLM Agents
