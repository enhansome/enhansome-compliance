...
* [LLM ISO27001](https://github.com/kriss-b/llm-iso27001) ⭐ 39 | 🐛 8 | 📅 2026-09-06 - Open-source ISO 27001 (+ 42001 + NIS2) ISMS framework designed to be entirely managed by LLM Agents
...
* [Apotrope](https://github.com/hexorcist404/apotrope) ⭐ 13 | 🐛 1 | 🌐 Python | 📅 2026-09-05 - Offline security posture auditor for Windows. Runs 50+ checks mapped to CIS Microsoft Windows Benchmarks and generates scored HTML/JSON reports.
