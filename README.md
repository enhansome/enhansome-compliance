...
* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,794 | 🐛 265 | 🌐 Go | 📅 2026-09-04 - Comprehensive security scanner for containers and IaC. Detects vulnerabilities, misconfigurations, secrets.
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,758 | 🐛 377 | 🌐 Python | 📅 2026-09-04 - AWS security and compliance scanner. Checks against AWS CIS Benchmark, GDPR, HIPAA, PCI DSS, SOC 2.
* [kube-bench](https://github.com/aquasecurity/kube-bench) ⭐ 8,173 | 🐛 100 | 🌐 Go | 📅 2026-08-24 - Checks Kubernetes clusters against CIS Kubernetes Benchmark.
...
* [CISO Assistant](https://github.com/intuitem/ciso-assistant-community) ⭐ 4,410 | 🐛 110 | 🌐 Python | 📅 2026-09-05 - Open-source GRC app supporting 40+ frameworks. Manages risks, controls, audits with one-click audit reports.
* [Comp AI](https://github.com/trycompai/comp) ⭐ 1,933 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-09 - Open source compliance platform (AGPL-3.0) for SOC 2, ISO 27001, HIPAA, GDPR.
...
* [Asqav](https://github.com/jagmarques/asqav-sdk) ⭐ 460 | 🐛 1 | 🌐 Python | 📅 2026-09-05 - Open-source SDK for AI agent governance with tamper-evident audit trails, tool scanning, and enforcement policies (MIT). Designed for teams running AI agents in production who need compliance-ready logging and control.
...
* [LLM ISO27001](https://github.com/kriss-b/llm-iso27001) ⭐ 39 | 🐛 8 | 📅 2026-09-05 - Open-source ISO 27001 (+ 42001 + NIS2) ISMS framework designed to be entirely managed by LLM Agents
...
* [Apotrope](https://github.com/hexorcist404/apotrope) ⭐ 13 | 🐛 2 | 🌐 Python | 📅 2026-09-05 - Offline security posture auditor for Windows. Runs 50+ checks mapped to CIS Microsoft Windows Benchmarks and generates scored HTML/JSON reports.
