...
* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,929 | 🐛 271 | 🌐 Go | 📅 2026-09-15 - Comprehensive security scanner for containers and IaC. Detects vulnerabilities, misconfigurations, secrets.
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,819 | 🐛 378 | 🌐 Python | 📅 2026-09-15 - AWS security and compliance scanner. Checks against AWS CIS Benchmark, GDPR, HIPAA, PCI DSS, SOC 2.
* [kube-bench](https://github.com/aquasecurity/kube-bench) ⭐ 8,186 | 🐛 104 | 🌐 Go | 📅 2026-09-07 - Checks Kubernetes clusters against CIS Kubernetes Benchmark.
* [ScoutSuite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,818 | 🐛 298 | 🌐 Python | 📅 2025-09-23 - Multi-cloud security auditing tool by NCC Group. Detects misconfigurations in AWS, Azure, GCP.
* [CISO Assistant](https://github.com/intuitem/ciso-assistant-community) ⭐ 4,429 | 🐛 102 | 🌐 Python | 📅 2026-09-15 - Open-source GRC app supporting 40+ frameworks. Manages risks, controls, audits with one-click audit reports.
* [Comp AI](https://github.com/trycompai/comp) ⭐ 1,962 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-09 - Open source compliance platform (AGPL-3.0) for SOC 2, ISO 27001, HIPAA, GDPR.
...
* [Probo](https://github.com/getprobo/probo) ⭐ 1,361 | 🐛 88 | 🌐 Go | 📅 2026-09-15 - Open source compliance automation focused on continuous integration workflows.
...
* [Asqav](https://github.com/jagmarques/asqav-sdk) ⭐ 529 | 🐛 2 | 🌐 Python | 📅 2026-09-15 - Open-source SDK for AI agent governance with tamper-evident audit trails, tool scanning, and enforcement policies (MIT). Designed for teams running AI agents in production who need compliance-ready logging and control.
...
* [Apotrope](https://github.com/hexorcist404/apotrope) ⭐ 13 | 🐛 2 | 🌐 Python | 📅 2026-09-15 - Offline security posture auditor for Windows. Runs 50+ checks mapped to CIS Microsoft Windows Benchmarks and generates scored HTML/JSON reports.
* [Venturalitica SDK](https://github.com/Venturalitica/venturalitica-sdk) ⭐ 6 | 🐛 3 | 🌐 Python | 📅 2026-09-15 - Open-source Python SDK (Apache-2.0) for EU AI Act and ISO 42001 compliance evidence generation from ML training pipelines. Produces OSCAL Assessment Results, CycloneDX ML BOM, bias audits, and Annex IV technical documentation as a byproduct of model training.
