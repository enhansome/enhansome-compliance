...
* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 38,048 | 🐛 264 | 🌐 Go | 📅 2026-09-23 - Comprehensive security scanner for containers and IaC. Detects vulnerabilities, misconfigurations, secrets.
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,860 | 🐛 385 | 🌐 Python | 📅 2026-09-23 - AWS security and compliance scanner. Checks against AWS CIS Benchmark, GDPR, HIPAA, PCI DSS, SOC 2.
* [kube-bench](https://github.com/aquasecurity/kube-bench) ⭐ 8,193 | 🐛 108 | 🌐 Go | 📅 2026-09-22 - Checks Kubernetes clusters against CIS Kubernetes Benchmark.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,592 | 🐛 61 | 🌐 Go | 📅 2026-09-23 - Policy-as-code runtime authorization for human and non-human identities. Audit logs of every access decision (Apache-2.0).
* [CISO Assistant](https://github.com/intuitem/ciso-assistant-community) ⭐ 4,448 | 🐛 116 | 🌐 Python | 📅 2026-09-23 - Open-source GRC app supporting 40+ frameworks. Manages risks, controls, audits with one-click audit reports.
* [Comp AI](https://github.com/trycompai/comp) ⭐ 1,985 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-23 - Open source compliance platform (AGPL-3.0) for SOC 2, ISO 27001, HIPAA, GDPR.
* [Probo](https://github.com/getprobo/probo) ⭐ 1,379 | 🐛 89 | 🌐 Go | 📅 2026-09-23 - Open source compliance automation focused on continuous integration workflows.
...
* [open-isms](https://github.com/NISD2/open-isms) ⭐ 15 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-23 - Self-hostable ISMS for the EU NIS 2 Directive (AGPL-3.0). Covers the 49 requirements from Directive 2022/2555 and Implementing Regulation 2024/2690, with GDPR, ISO 27001, the EU AI Act and the CRA mapped against them. Owner, deadline and sign-off per requirement, plus an append-only audit trail. ([Website](https://www.nisd2.eu) | [Self-hosting](https://github.com/NISD2/open-isms/blob/main/docs/self-hosting.md) ⭐ 15 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-23)
